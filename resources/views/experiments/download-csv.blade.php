<x-layouts.app>
    <div class="container">
        ...
        <a href="{{ route('experiments.download-csv.responses', $experiment->id) }}" class="btn btn-success">Download Responses CSV</a>

        <h3 class="mt-5">Fields</h3>
        <p>Press the button below to download the list of fields of this experiment as a .csv file.</p>
        <a href="{{ route('experiments.download-csv.fields', $experiment->id) }}" class="btn btn-success">Download Fields CSV</a>
    </div>
</x-layouts.app>
