<x-layouts.app>
    <div class="container">
                            ...
                            <tr data-id="{{ $field->id }}">
                                ...
                                <td>
                                    <form action="{{ route('experiments.fields.destroy', [$experiment->id, $field->id]) }}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to remove this field?')" >R</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
        ...
        <button id="addFieldBtn" type="button" class="btn btn-primary" data-bs-toggle="modal"
