...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link @if(request()->routeIs('experiments.show') || request()->routeIs('participants.create') || request()->routeIs('participants.show')) active @endif" aria-current="page" href="{{ route('experiments.show', $experiment->id) }}">Participants</a>
    </li>
    <li class="nav-item">
